...
;; ***	genFunction  2342 curr label offset=31previous max_key=0 
...
;; 	line = 7129 result AOP_REG=r0x1050, size=1, left -=-, size=0, right AOP_DIR=_TRISB, size=1
;; ***	genCast  7253
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7277:genCast
;;	1009
;;	1028  _TRISB   offset=0
	.line	25; "pic1.c"	BIT_CLEAR(TRISB, 1); 
	BANKSEL	_TRISB
	MOVF	_TRISB,W
...
;; ***	aopForSym 315
;;	327 sym->rname = _TRISB, size = 1
;; 	line = 3955 result AOP_DIR=_TRISB, size=1, left AOP_REG=r0x1050, size=1, right AOP_LIT=0xfd, size=1
...
;;	1009
;;	1028  _TRISB   offset=0
	.line	26; "pic1.c"	BIT_CLEAR(TRISB, 2);
	MOVF	_TRISB,W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7278:genCast
;;	1109 rIdx = r0x1050 
	BANKSEL	r0x1003
...
;; ***	aopForSym 315
;;	327 sym->rname = _TRISB, size = 1
;; 	line = 3955 result AOP_DIR=_TRISB, size=1, left AOP_REG=r0x1050, size=1, right AOP_LIT=0xfb, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4190:genAnd
	MOVLW	0xfb
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4191:genAnd
;;	1109 rIdx = r0x1050 
...
;;	575
;; 	line = 4227 result AOP_DIR=_PORTB, size=1, left AOP_DIR=_PORTB, size=1, right AOP_LIT=0x02, size=1
;; 	line = 4253 result AOP_DIR=_PORTB, size=1, left AOP_DIR=_PORTB, size=1, right AOP_LIT=0x02, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4404:genOr
	.line	28; "pic1.c"	BIT_SET(PORTB, 1);  
	BANKSEL	_PORTB
	BSF	_PORTB,1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	327 sym->rname = _PORTB, size = 1
;;	575
;; 	line = 4227 result AOP_DIR=_PORTB, size=1, left AOP_DIR=_PORTB, size=1, right AOP_LIT=0x04, size=1
;; 	line = 4253 result AOP_DIR=_PORTB, size=1, left AOP_DIR=_PORTB, size=1, right AOP_LIT=0x04, size=1
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4404:genOr
_00149_DS_
	.line	33; "pic1.c"	BIT_SET(PORTB, 2); 
	BANKSEL	_PORTB
	BSF	_PORTB,2
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6686:genPointerSet *{*
...
;;/home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6461: size=0, offset=0, AOP_TYPE(res)=8
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6470:genDataPointerSet
	.line	34; "pic1.c"	DELAY_BIG_US(1000);
	MOVLW	0xb4
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6471:genDataPointerSet
;;	popGet AOP_PCODE (PO_IMMEDIATE + 0) 1130 _dvar
	BANKSEL	_dvar
...
;;	327 sym->rname = _PORTB, size = 1
;;	575
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4643:genXor
	.line	36; "pic1.c"	BIT_TOGGLE(PORTB,1);
	MOVLW	0x02
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4644:genXor
;;	1009
...
;; ***	popGetLabel  key=14, label offset 35
	GOTO	_00149_DS_
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2760:genLabel *{*
;; ***	genLabel  2763
...
;***
;entry:  _cycle_eater	;Function start
; 2 exit points
;has an exit
;; Starting pCode block
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;;	1109 rIdx = r0x104B 
	.line	12; "/home/federico/Projects/piklabworkspace/delay.h"	void delay_ms(unsigned long ms) {
	BANKSEL	r0x1004
	MOVWF	r0x1004
...
;;	694 register type nRegs=4
;;	694 register type nRegs=4
;; 	line = 6937 result AOP_REG=r0x104C, size=4, left -=-, size=0, right AOP_REG=r0x1048, size=4
;; ***	genAssign  7023
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1343:mov2w_op *{*
;; ***	mov2w  1381  offset=0
...
;;	1109 rIdx = r0x1048 
_00106_DS_
	.line	15; "/home/federico/Projects/piklabworkspace/delay.h"	while (ms--){
	BANKSEL	r0x1007
	MOVF	r0x1007,W
...
;;	1109 rIdx = r0x1048 
	ADDWF	r0x1007,F
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:465:genAddLit
	MOVLW	0xff
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:469:genAddLit
	BTFSS	STATUS,0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:470:genAddLit
;;	1109 rIdx = r0x1049 
	ADDWF	r0x1006,F
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:465:genAddLit
	MOVLW	0xff
...
;; ***	genAssign  6928
;;	694 register type nRegs=4
;; 	line = 6937 result AOP_REG=r0x104C, size=4, left -=-, size=0, right AOP_LIT=0x00, size=4
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1109 rIdx = r0x104C 
	.line	17; "/home/federico/Projects/piklabworkspace/delay.h"	for (u = 0; u < loops; u++) { 
	CLRF	r0x1008
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1109 rIdx = r0x104D 
...
;;unsigned compare: left < lit(0x4=4), size=4
...
;; ***	popGetLabel  key=2, label offset 4
	GOTO	_00106_DS_
;;genSkipc:3247: created from rifx:0xff925604
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:4738:pic14_genInline *{*
;; ***	pic14_genInline  4739
...
;;	694 register type nRegs=4
;;	575
;; 	line = 618 result AOP_REG=r0x104C, size=4, left AOP_REG=r0x104C, size=4, right AOP_LIT=0x01, size=1
...
;	   96+   16 =   112 instructions (  256 byte)
