...
void main(void)
{
	...
	//sprintf(string, "r:%f.2", roll);
	//putrsXLCD("string1");	// Enviamos mensaje al LCD
	
	if (roll==0)
	  putrsXLCD("Leveled");	// Enviamos mensaje al LCD
	else{if (roll <0)
	      putrsXLCD("Right");	// Enviamos mensaje al LCD
	      else putrsXLCD("Left");	// Enviamos mensaje al LCD
	}  
	Delay1KTCYx(10);	
	...
	//putrsXLCD("string");	// Enviamos mensaje al LCD
