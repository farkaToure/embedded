...
?_addup:	; 4 bytes @ 0x0
	global	?_increment
?_increment:	; 4 bytes @ 0x0
	global	Delay1KTCYx@unit
Delay1KTCYx@unit:	; 1 bytes @ 0x0
	global	addup@param1
addup@param1:	; 2 bytes @ 0x0
	global	increment@param1
increment@param1:	; 2 bytes @ 0x0
	ds   1
	global	??_Delay1KTCYx
??_Delay1KTCYx:	; 0 bytes @ 0x1
	ds   1
	global	??_increment
??_increment:	; 0 bytes @ 0x2
	global	addup@param2
addup@param2:	; 2 bytes @ 0x2
	ds   2
	global	??_addup
??_addup:	; 0 bytes @ 0x4
	global	??_main
...
;!
;!    ?_increment	long  size(2) Largest target is 0
;!
;!    ?_addup	long  size(2) Largest target is 0
;!
...
;!                          _increment
;! ---------------------------------------------------------------------------------
;! (1) _Delay1KTCYx                                          1     0      1      15
;!                                              0 COMRAM     1     0      1
;! ---------------------------------------------------------------------------------
;! (1) _addup                                                4     0      4      10
;!                                              0 COMRAM     4     0      4
;! ---------------------------------------------------------------------------------
;! (1) _increment                                            2     0      2       5
;!                                              0 COMRAM     2     0      2
;! ---------------------------------------------------------------------------------
...
;; *************** function _main *****************
;; Defined at:
;;		line 33 in file "/home/federico/Projects/piklabworkspace/c18_2/c18_2.c"
...
psect	text0
psect	text0
	file	"/home/federico/Projects/piklabworkspace/c18_2/c18_2.c"
	line	33
...
l1794:
	btg	((c:3978)),c,7	;volatile
	line	48
	
l1796:
	movwf	(??_main+0+0)&0ffh,c
	movlw	low(0E8h)
	movwf	((c:?_Delay1KTCYx)),c
	movf	(??_main+0+0)&0ffh,c,w
	call	_Delay1KTCYx	;wreg free
	line	50
...
l1800:
	btfss	((c:3978)),c,6	;volatile
	bra	u1825
	bsf	((c:3978)),c,0	;volatile
	bra	u1827
	u1825:	
...
l1802:
	...
	movwf	((c:?_addup)),c
	movlw	high(01h)
	movwf	(1+((c:?_addup)+02h)),c
	movlw	low(01h)
	movwf	(0+((c:?_addup)+02h)),c
	call	_addup	;wreg free
	line	53
	
l1804:
	movlw	high(02h)
	movwf	((c:?_increment+1)),c
	movlw	low(02h)
	movwf	((c:?_increment)),c
...
;; Defined at:
;;		line 9 in file "/usr/hitech/picc-18/9.80/sources/d1ktcyx.c"
;; Parameters:    Size  Location     Type
...
__ptext1:
psect	text1
	file	"/usr/hitech/picc-18/9.80/sources/d1ktcyx.c"
	line	9
...
;; *************** function _addup *****************
;; Defined at:
;;		line 3 in file "./src/addup.c"
;; Parameters:    Size  Location     Type
;;  param1          2    0[COMRAM] int 
;;  param2          2    2[COMRAM] int 
;; Auto vars:     Size  Location     Type
;;		None
;; Return value:  Size  Location     Type
;;                  4    0[COMRAM] long 
...
psect	text2
	file	"./src/addup.c"
	line	3
	global	__size_of_addup
	__size_of_addup	equ	__end_of_addup-_addup
...
l614:
	line	5
;	Return value of _addup is never used
	
l25:
	return
	opt stack 0
GLOBAL	__end_of_addup
	__end_of_addup:
	signat	_addup,8316
	global	_increment
...
;; *************** function _increment *****************
;; Defined at:
;;		line 3 in file "./src/increment.c"
;; Parameters:    Size  Location     Type
;;  param1          2    0[COMRAM] int 
;; Auto vars:     Size  Location     Type
;;		None
...
l616:
;	Return value of _increment is never used
	infsnz	((c:increment@param1)),c
	incf	((c:increment@param1+1)),c
	goto	l28
